            ...
            switch (opcion) {
                case 1:
                    ...
                    if (buscado == null) {
                        ...
                        //La direccion de memoria del producto "buscado" es la misma tanto para el arbol como para la lista.
                        //Por ende el stock se actualiza en ambos.
                        buscado.setStock(buscado.getStock() + producto.getStock());
